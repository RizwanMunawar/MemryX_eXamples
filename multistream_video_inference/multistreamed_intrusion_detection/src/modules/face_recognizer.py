"""
Face Recognition Module using YOLOv8n-face and FaceNet
Adapted from realtime_multiface_recognition/src/modules/MXFace.py
"""
import queue
import logging
...
class FaceRecognizer:
    """Face detection and recognition using YOLOv8n-face and FaceNet"""
    detector_imgsz = 640
    ...
    def stop(self):
        logger.info('stop')
        print('Shutting down FaceRecognizer')
