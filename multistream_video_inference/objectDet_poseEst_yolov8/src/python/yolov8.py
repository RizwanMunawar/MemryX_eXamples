...
class YoloV8:
    ...
    class NumpyPostProcess:
        ...
        def __call__(self, lbox, lcls, mbox, mcls, sbox, scls, onnx_format=True) -> np.ndarray:
...
###################################################################################################
    def preprocess(self, img):
        ...
        # Change to (640, 640, 1, 3) for numpy mode
        blob = blob.transpose(2, 3, 0, 1)
...
###################################################################################################
    def postprocess(self, output):
        ...
        # Process output using NumpyPostProcess
        ...
        # Convert distances to actual bounding boxes for valid detections only
