# Personal Protective Equipment Detection Using YOLOv8s Custom-trained Model

The **PPE detection and tracking** example demonstrates real-time object detection using the YOLOv8 small model (trained on a Personal Protective Equipment dataset) on MemryX accelerators. The object tracking is added for stable prediction results across different environments.

This guide provides setup instructions, model details, and necessary code snippets to help you quickly get started.
...
# Load a model
model = YOLO("ppe_small.pt")  # load the custom-trained model weights
